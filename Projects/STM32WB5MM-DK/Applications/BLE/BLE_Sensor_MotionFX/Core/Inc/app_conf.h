 ...
 */
#define CFG_GAP_DEVICE_NAME             "WB5M CUBE"
...
#define CFG_LED_BAR_SHIELD_SUPPORTED         0//1
...
typedef enum
{
    ...
    CFG_TASK_CONN_2M_UPDATE_REG_ID,
...
typedef enum
{
    ...
    CFG_TASK_DISPLAY_LINK_ID,
    CFG_TASK_LED_BAR_SHIELD_UPDATE_ID,
